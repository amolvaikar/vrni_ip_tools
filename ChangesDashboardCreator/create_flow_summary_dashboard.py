...
def create_flow_dashboard(session, dashboard_name):
    dashboard_id = create_dashboard(session, dashboard_name, "")
    print(dashboard_id)
    if dashboard_id:
        generate_flow_dashboards(session, dashboard_id)
    return

def generate_flow_dashboards(session, dashboard_id):
    print("generate_application_dashboards")

    discovery_dashboard_name = "Top 10 VM pairs by traffic"
    ...
    discovery_dashboard_name = "Metrics of Top 10 VM pairs by traffic"
    ...
    discovery_dashboard_name = "Top 10 L2 pairs by traffic"
    ...
    discovery_dashboard_name = "Metrics of Top 10 L2 pairs by traffic"
    ...
    discovery_dashboard_name = "Top 10 Host pairs by traffic"
    ...
    discovery_dashboard_name = "Metrics of Top 10 Host pairs by traffic"
    ...
    discovery_dashboard_name = "Top 10 ports by traffic"
    ...
    discovery_dashboard_name = "Metrics of Top 10 ports by traffic"
    ...
    discovery_dashboard_name = "Top 10 Internet flow per port"
    ...
    discovery_dashboard_name = "Metrics of Top 10 Internet flow per port"
...
if __name__ == '__main__':
    ...
    create_flow_dashboard(session, dashboard_name)
