...
def generate_application_pinboards(session, pinboard_id, application_name):
    ...
    # discovery_pinboard_name = "L2 Networks Count"
    # discovery_query = "count of NSX-T Layer2 Network where NSX Policy Segment in (list(l2network) of vm where application like '{}')".format(application_name)
    # print(discovery_query)
    # add_pin_to_pinboard(session, pinboard_id, discovery_pinboard_name, discovery_query)
    #
    # discovery_pinboard_name = "Logical Port Count"
    # discovery_query = "count of NSX-T Logical Port where vm in (vm where application like '{}')".format(application_name)
    # print(discovery_query)
    # add_pin_to_pinboard(session, pinboard_id, discovery_pinboard_name, discovery_query)
    #
    # discovery_pinboard_name = "Host Count"
    # discovery_query = "count of host where vm in (vm where application like '{}')".format(application_name)
    # print(discovery_query)
    # add_pin_to_pinboard(session, pinboard_id, discovery_pinboard_name, discovery_query)
    #
    # discovery_pinboard_name = "Tier-1 Routers"
    # discovery_query = "count of NSX-T Router where vrf in (list(Default gateway Router) of vm where application like '{}') ".format(application_name)
    # print(discovery_query)
    # add_pin_to_pinboard(session, pinboard_id, discovery_pinboard_name, discovery_query)
    #
    # discovery_pinboard_name = "Router Interfaces on Tier-1"
    # discovery_query = "count of Router Interface where vrf in (list(Default gateway Router) of vm where application like '{}')".format(application_name)
    # print(discovery_query)
    # add_pin_to_pinboard(session, pinboard_id, discovery_pinboard_name, discovery_query)
    #
    # discovery_pinboard_name = "Transport Node Count of Tier-1"
    # discovery_query = "count of NSX-T Transport Node where in (list (Active Transport Node) of NSX-T Service Router where Logical Router.vrf  in (list(Default gateway Router) of vm where application like '{}')) ".format(application_name)
    # print(discovery_query)
    # add_pin_to_pinboard(session, pinboard_id, discovery_pinboard_name, discovery_query)
